...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        for i in range(0, len(audio_paths), batch_size):
            ...
            # Load audio files
            wav_list = [load_audio(path, target_sample_rate=generator.sample_rate).squeeze().to(device) for path in batch_paths]
            ...
            for path, syn_wav in zip(batch_paths, syn_wav_list):
                ...
                save_audio(output_path, syn_wav.cpu().reshape(1, -1), sample_rate=generator.sample_rate)
